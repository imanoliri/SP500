...
def plot_histograms(
    ...
    for col, title in zip(columns, titles):
        plot_hist(
            df, col, title, path, bins, with_boxplot, sharex, ignore_outliers, save_plot
        )
...
def overlap_plot(
    df1: pd.DataFrame,
    df2: pd.DataFrame,
    series_to_plot_1: List[Tuple[str, str, str, dict]],
    series_to_plot_2: List[Tuple[str, str, str, dict]],
    path: str = None,
    save: bool = True,
    title: str = None,
    **kwargs,
